...
export default function WelcomeBanner({
  ...
  return (
    <section
      id="about"
      className="grid lg:grid-cols-2 gap-12 items-center py-16 relative"
    >
      ...
      <div className="relative z-10">
        <div className="egg-shape inline-block border border-primary text-primary mb-6 py-2 px-4">
          Welcome
        </div>
        ...
        <p className="mt-6 text-base lg:text-lg text-neutral/70 max-w-xl">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-4">
          <a href="#contact" className="btn btn-primary p-2 rounded-md">
            Contact Me
          </a>
          <a
            href="#portfolio"
            className="inline-flex items-center gap-2 text-neutral/70 hover:text-primary transition"
          >
            View Portfolio{" "}
