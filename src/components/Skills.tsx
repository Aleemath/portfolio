...
export default function Skills({ description }: SkillsProps) {
  ...
  return (
    <section id="skills" className="bg-white py-20 relative">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <p className="mt-6 text-base lg:text-lg text-neutral/70 max-w-2xl leading-relaxed">
              {description ||
            ...
            <button
              ...
              className="btn btn-primary btn-lg rounded-md mt-10 px-8 py-3 text-base font-medium"
            >
              Hire Me
            </button>
          </div>
              ...
              return (
                ...
                >
                  <div className="card-body p-6">
                    ...
                    <h3 className="card-title text-lg font-bold mb-2 text-neutral">
                      {item.title}
                    </h3>
